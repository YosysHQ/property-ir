...
|                      |                 |                                                |                          |
+----------------------+-----------------+------------------------------------------------+--------------------------+
| delay                |  ``##m``        | ``clk-seq-delay``                              |  16.7 Sequences          |
|                      |                 |                                                |                          |
|                      |  ``##[m:n]``    |                                                |  (p. 399--401)           |
|                      |                 |                                                |                          |
|                      |  ``##[m:$]``    |                                                |                          |
+----------------------+-----------------+------------------------------------------------+                          +
| concatenation        | ``##1``         | ``clk-seq-concat``                             |                          |
|                      |                 |                                                |                          |
+----------------------+-----------------+------------------------------------------------+                          +
| fusion               | ``##0``         | ``clk-seq-fusion``                             |                          |
|                      |                 |                                                |                          |
+----------------------+-----------------+------------------------------------------------+--------------------------+
| consecutive          | ``[*m]``        | ``clk-seq-repeat``                             | 16.9.2 Repetition        |
...
|                     |                                | ``clk-prop-weak-bool``                     | operators (p. 458)             |
|                     |                                |                                            |                                |
+                     +--------------------------------+--------------------------------------------+                                +
|                     |                                | ``clk-prop-seq``                           |                                |
|                     |                                |                                            |                                |
