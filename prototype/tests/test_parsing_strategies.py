...
@example(['document', ['declare-input', '0'], ['parse-sexpr', '0']])
...
@example(['document', ['declare-input', '1'], ['parse-sexpr', ['let-rec', ['0', '1'], ['00', '000'], ['000', '1'], '0']]])
...
@example(['document', ['declare-input', 'o'], ['declare-rec', ['declare', '3g', ['not', 'o']]], ['declare-rec', ['declare', '0', '3g']]])
