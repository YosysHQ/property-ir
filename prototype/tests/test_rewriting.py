...
def test_nnf_boolean_no_cycle():
    ...
    expected_output_document = wrap_multiple_statements_in_document([input_statement1, input_statement2, expected_output_statement3])
...
def test_nnf_boolean_even_cycle():
    ...
    input_document: RawSExprList = wrap_statement_in_document(input_raw_sexpr)
    expected_output_document = wrap_statement_in_document(expected_output_raw_sexpr)
    check_nnf_equivalence(input_document, expected_output_document)
